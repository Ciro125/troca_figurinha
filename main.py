...
def main():
    ...
    nome_remover_figurinha_tem = st.text_input("Nick (igual ao registrado) para Remover Figurinha do Tem")
    ...
    nome_adicionar_figurinha_quer = st.text_input("Nick (igual ao registrado) para Adicionar Figurinha ao Quer")
    ...
    nome_remover_figurinha = st.text_input("Nick (igual ao registrado) para Remover Figurinha")
    ...
    nome_para_retirar = st.text_input("Nick (igual ao registrado) para Retirar")
